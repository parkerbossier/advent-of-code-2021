...
const day3data_1 = require("./day3data");
function main1(data) {
...
function main2(data) {
    ...
    for (let i = 0; i < data[0].length; i++) {
        ...
        const keyMode = (() => {
            if (keyOneCount === o2Data.length - keyOneCount)
                return '1';
            else if (keyOneCount > o2Data.length - keyOneCount)
                return '1';
            else
                return '0';
        })();
    ...
    for (let i = 0; i < data[0].length; i++) {
        ...
        const keyOneCount = oneCounts[i];
        const keyMode = (() => {
            if (keyOneCount === co2Data.length - keyOneCount)
                return '0';
            else if (keyOneCount > co2Data.length - keyOneCount)
                return '0';
            else
                return '1';
        })();
...
const data = day3data_1.day3data.split('\n');
main1(data);
main2(data);
